...
|19.04.2022|f-строки и области видимости: локальная (local), объемлющая (enclosing), глобальная (global) и встроенная (builtin).|[Видео урока](https://drive.google.com/drive/folders/1f6k7K5VOhBklpgIUbBQ1WD2TkX8bxnGJ?usp=sharing)|[Листинг](./seminars/04.19.2022/practice_7.py)|
